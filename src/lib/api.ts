...
export const adminAPI = {
  ...
  getLeaguePicksOverviewForEvent: (weekNumber: number, eventType: 'race' | 'sprint', seasonYear?: number | null) => apiService.get(`/admin/league-picks-overview/event?weekNumber=${weekNumber}&eventType=${eventType}${seasonYear != null ? `&seasonYear=${seasonYear}` : ''}`),
