...
export default function ShareLeaguePage() {
    const { user } = useAuth();
    ...
    const handleJoinLeague = async () => {
        if (!user) {
            ...
            window.location.href = `/login?redirect=/share/${joinCode}`;
            return;
        }
                    ...
                    <div className="bg-white shadow rounded-lg p-6 mb-6">
                        <div className="text-center mb-6">
                            <div className="h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-4">
                                <span className="text-blue-600 font-bold text-xl">{league?.name?.charAt(0).toUpperCase()}</span>
                            </div>
                        ...
                        {!user ? (
                            <div className="text-center">
                                ...
                                <Link
                                    href={`/login?redirect=/share/${joinCode}`}
